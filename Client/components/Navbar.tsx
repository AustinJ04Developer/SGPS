...
export default function Navbar() {
  ...
  const mqttChip = {
    ...
    disconnected: { label: "Reconnecting", color: "#d97706", bg: "#fffbeb", border: "#fcd34d", Icon: WifiOff,       spin: false },
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 11 }}>
          <div style={{
            ...
            <svg width="32" height="32" viewBox="0 0 680 560" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <div style={{
              ...
              fontSize: 15, color: "#0f172a", lineHeight: 1.2,
            }}>
              SmartPark
            </div>
          ...
          <div style={{
            ...
            <mqttChip.Icon
              ...
              style={{
                ...
                animation: mqttChip.spin ? "spin 1s linear infinite" : "none",
              }}
            />
      ...
      {mqttStatus === "error" && (
        <div style={{
          ...
          Real-time sensor is unreachable. Data shown may be from the last successful sync. Polling every 15 s as fallback.
        </div>
      )}
